...
def escribir_duraciones_especifico(ws, resultados, header_fill, header_font, border, center, tipo_est, tipo_veh):
    """Escribe datos de duraciones por vehículo para un tipo de establecimiento y vehículo específico."""
    titulo_est = 'VÍA' if tipo_est == 'via' else 'PARQUEADERO'
    ws['A1'] = f'Duraciones por Vehículo - {titulo_est} - {tipo_veh.upper()}'
    ws['A1'].font = Font(bold=True, size=12)
